...
--   mysql -u root -p buildlink < backend/db/schema.sql

CREATE DATABASE IF NOT EXISTS buildlink CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE buildlink;
...
CREATE TABLE IF NOT EXISTS constructor_profiles (
...
CREATE TABLE IF NOT EXISTS constructor_specializations (
...
CREATE TABLE IF NOT EXISTS constructor_service_regions (
  constructor_id INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS request_constructor_targets (
